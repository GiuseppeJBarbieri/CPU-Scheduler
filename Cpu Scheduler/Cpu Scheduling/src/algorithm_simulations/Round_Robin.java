...
public class Round_Robin {
	...
	public ArrayList<Process_Object> simulateRR() {
		...
		getArrivalTime(orderOfProcesses);
	...
	public void setTextFieldInfo(ArrayList<TextField> waitTxtList, ArrayList<TextField> taTxtList, TextField avgWaitTxt, TextField avgTaTxt) {
		int lastExitTime = 0;
		int taTime = 0;
		double avgWait = 0;
		double avgTA = 0;
